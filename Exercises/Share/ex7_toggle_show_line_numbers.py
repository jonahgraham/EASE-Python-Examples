# Write a program to read a boolean preference value, then toggle the value

# 1. load UI and Platform module
...
# 4. execute the function using the executeUI method 
